...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 60, "arg-type table must include upstream model observation, timing_breakdown, and session_id")
	...
	// created_at is last; timing_breakdown follows session_id.
